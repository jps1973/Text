...
#define TOOLBAR_WINDOW_CLASS_NAME												TOOLBARCLASSNAME

#define TOOLBAR_WINDOW_EXTENDED_STYLE											0
#define TOOLBAR_WINDOW_STYLE													( WS_CHILD | WS_VISIBLE | TBSTYLE_FLAT )
#define TOOLBAR_WINDOW_TEXT														NULL

#define TOOL_BAR_WINDOW_BUTTON_STATE											TBSTATE_ENABLED
#define TOOL_BAR_WINDOW_BUTTON_STYLE											BTNS_AUTOSIZE
#define TOOL_BAR_WINDOW_BUTTON_SIZE												16

#define TOOL_BAR_WINDOW_IMAGE_LIST_INDEX										0
