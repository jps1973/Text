...
LRESULT CALLBACK MainWindowProcedure( HWND hWndMain, UINT uMessage, WPARAM wParam, LPARAM lParam )
{
	...
	switch( uMessage )
	{
		...
		case WM_COMMAND:
		{
			...
			switch( LOWORD( wParam ) )
			{
				...
				case IDM_EDIT_SELECT_ALL:
				{
					...
					// Select all text in control window
					ControlWindowSelectText();
		...
		case WM_CLOSE:
		{
			...
			// Save control window text
			if( ControlWindowSave( TEXT_FILE_NAME ) )
			{
			...
			} // End of successfully saved control window text
			else
			{
				// Unable to save control window text

				// Ensure that user is happy to close
				...
				} // End of user is happy to close

			} // End of unable to save control window text
	...
	else
	{
		...
		if( RegisterClassEx( &wcMain ) )
		{
			...
			if( hWndMain )
			{
				...
				{
					// Successfully loaded text into control window

					// Select text in control window
					ControlWindowSelectText();

				} // End of successfully loaded text into control window
